# 📚 Reflexão sobre o Curso GitHub Basics

## O que aprendi

Este curso forneceu uma introdução sólida aos conceitos fundamentais do Git e GitHub:

### Git e Controle de Versão
- **Git** é um Sistema de Controle de Versão Distribuído (DVCS) que permite rastrear mudanças no código
- Facilita a colaboração e permite reverter para versões anteriores quando necessário
- GitHub é a plataforma online que disponibiliza Git com uma interface amigável

### Fluxo do GitHub
- **Repositórios**: Pastas de projeto que contêm todos os arquivos e histórico de revisão
- **Clonagem**: Copia repositórios remotos para a máquina local
- **Commits e Push**: Adicionam changesets locais ao repositório remoto
- **Branches**: Isolam trabalho para experimentação segura antes de merge no main
- **Pull Requests**: Permitem revisar e discutir mudanças antes de integração
...
### Recursos do GitHub
- Issues para rastrear bugs, tarefas e enhancements
- Project boards para organizar e priorizar trabalho
- Markdown para documentação e formatação
- Comunidade e exploração de projetos
- Perfis de usuário e funcionalidades de networking

## Pontos-chave que entendi

✅ A importância de commits bem documentados  
✅ Como branches permitem iteração segura  
✅ Pull requests são ferramentas críticas de colaboração  
✅ Markdown torna a documentação mais acessível  
✅ GitHub é mais que um repositório - é uma rede de colaboração  

## Próximos passos

Pretendo aprofundar conhecimento em:
- Workflows avançados com Git (rebase, cherry-pick)
- CI/CD com GitHub Actions
- Práticas de colaboração em projetos open source
- Melhor documentação de projetos

---

**Tarefa concluída em:** 27 de Fevereiro de 2026
